...
import { validateAdminSlug } from "../apps/admin/dist/index.js";
...
assertIncludes(contents.home, "Personal blog by Static Author", files.home);
...
assertIncludes(contents.post, "1 min read", files.post);
...
assertIncludes(contents.tag, "Tag: markdown", files.tag);
